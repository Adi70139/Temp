            ...
            <div className={`w-52 h-8 my-5 border border-gray-700 rounded ${currColor ? 'bg-[#222426]' : 'bg-[#fff]'}`}>
                ...
                <div className="p-2 sm:p-5 font-sans font-semibold space-y-5">
                    ...
                    <div className="text-xs flex gap-2">
                        <div className={`${currColor ? 'border-gray-300' : 'border-gray-700'} border-r pr-2`}>
                        ...
                        <div className="flex gap-4">
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <div className={`${currColor ? 'text-gray-400' : 'text-black'} font-inter font-normal text-xs`}>
                                        Sent <span className="font-normal">8th, March</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex gap-4">
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-2">
                                    <Mail color={currColor ? "white" : "black"} className='w-3' />
                                    <div className={`${currColor ? 'text-gray-400' : 'text-black'} font-inter font-normal text-xs`}>
                                        Opened <span className="font-normal">22nd, March</span>
                                    </div>
                                </div>
                            </div>
                        </div>
