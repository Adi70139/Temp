...
const Home = () => {
  ...
  return (
    <div
      className={`w-full h-full m-auto max-w-[1440px] ${
        currColor ? "bg-black" : "bg-white"
      } ${currColor ? "text-white" : "text-black"} h-10 flex`}
    >
          ...
          >
            <div className="w-[200px] ml-5  pr-3">
              ...
              <div className="flex justify-between text-[14px]">
                ...
                <div className="flex items-center gap-2">
                  <p style={{ cursor: "pointer" }}>Newest</p>
                  <ChevronDown />
                </div>
              </div>
              <hr className="mt-2.5" />
        ...
        <Modal isOpen={isModalOpen} onClose={closeModal}>
          <div className="w-[440px] h-[240px] text-white ">
            <div className="h-full ">
              <h1 className="text-[24px] font-bold mt-8 ml-32">
                Are you Sure ?
              </h1>
              <p className="mt-8 text-[#E8E8E8] ml-24">
